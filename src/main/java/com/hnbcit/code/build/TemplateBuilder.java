...
import com.hnbcit.code.swagger.*;
import com.hnbcit.code.util.JavaTypes;
import com.hnbcit.code.util.ModelInfo;
import com.hnbcit.code.util.StringUtils;
...
public class TemplateBuilder {
    ...
    static {
        try {
            //加载配置文件
//            InputStream is = TemplateBuilder.class.getClassLoader().getResourceAsStream("application_back.properties");
